...
/**
 * Created by Ashwin on 10/10/2018.
 */

object SharedPrefsManager {
    const val PREFS_FILENAME = "com.myapp.prefs"

    fun sharedPrefs(context: Context): SharedPreferences = context.getSharedPreferences(PREFS_FILENAME, Context.MODE_PRIVATE)
